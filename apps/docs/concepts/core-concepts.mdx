...
value histogram panels, dot plots, and scatter plots; scatter combines any two
numeric loaded-run fields, including metric aggregates, config fields, metadata
fields, duration, or created time.
