...
Representative framework callback events without installing optional framework
dependencies.
...
Inspect Optuna, tree-boosting, RL, Hugging Face Dataset, and DVC metadata keys
on one run.
