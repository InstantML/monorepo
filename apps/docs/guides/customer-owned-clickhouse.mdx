...
<Note>
Usage storage guardrails for BYOC count only artifact bytes stored by InstantML in Cloudflare R2. They do not count customer-owned ClickHouse database bytes.
</Note>
