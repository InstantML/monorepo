...
- Filter your memberships when you belong to many workspaces.
...
Plan seat counts are organization-workspace allowances. Personal workspaces
always stay one owner seat; create or switch to an organization workspace when
you want to invite teammates.
