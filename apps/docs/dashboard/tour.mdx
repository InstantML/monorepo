...
the newest checkpoint, jump to Compare, or request a stop. Tabs cover the
overview, metrics, artifacts, logs, config and source context, and lineage.

![Run Detail Artifacts tab showing checkpoints and evaluation evidence](/images/product/dashboard-artifacts-evidence.png)

The Artifacts tab lists checkpoints, rich objects, evaluation bundles, media,
