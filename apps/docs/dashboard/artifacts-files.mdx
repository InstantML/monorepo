...
The Artifacts tab exposes copyable artifact IDs and safe download states. The [API tab](/dashboard/api-tab) exposes copyable route snippets, so you can fetch artifacts or inspect API behavior without digging through browser network panels.
