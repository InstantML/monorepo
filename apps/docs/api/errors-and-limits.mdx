...
| --- | ---: | ---: | ---: |
| Free | 5 req/sec, burst 30 | 2 req/sec | 500k requests |
| Pro | 50 req/sec, burst 250 | 25 req/sec | 25M requests |
| Premium | 200 req/sec, burst 1000 | 100 req/sec | 150M requests |
