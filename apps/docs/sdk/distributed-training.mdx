...
<Note>
Rank metric rows count toward the same monthly metric-point usage guardrail as ordinary scalar metric rows.
</Note>
...
- [SDK patterns by workflow](/sdk/examples-patterns)
- [Usage limits and billing](/guides/pricing-limits-billing)
