...
| --- | --- | --- |
| Browser / dashboard | Cloud Run control and data services | InstantML-owned ClickHouse on Google Cloud |
| Python SDK / uploader | Cloud Run control and data services | InstantML-owned ClickHouse on Google Cloud |
