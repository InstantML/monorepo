...
use crate::domain::{
    ...
    BatchRunLifecycleRequest, BillingAccountProjection, BillingCancelRequest, BillingChangeIntent,
    BillingCheckoutInfo, BillingCheckoutIntent, BillingCheckoutRequest, BillingCheckoutSyncRequest,
    BillingEventRecord, BillingPlanChangeRequest, BillingPortalRequest, BillingSeatChangeRequest,
    ...
    DeleteArtifactVersionRequest, DeleteRunRequest, DevGoogleAuthRequest, DeviceCodeClientInfo,
    ...
    RunLifecycleRequest, RunLifecycleRow, RunRow, SaveWorkspaceViewRequest, SeatRow, SeatUserRow,
    ServiceAccountRow, SetArtifactAliasRequest, StopAckRequest, StopRunRequest, StopRunsRequest,
...
#[openapi(
    ...
    paths(
        ...
        crate::http::handlers::runs::archive_run,
        crate::http::handlers::runs::restore_run,
        crate::http::handlers::runs::delete_run,
        crate::http::handlers::runs::batch_run_lifecycle,
