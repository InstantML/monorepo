...
#[utoipa::path(
    ...
    params(
        ...
        ("from" = Option<String>, Query, description = "RFC3339 lower bound over started_at. Project-scoped lists default to a recent window; run_id lists are unbounded unless from/to is supplied."),
        ("to" = Option<String>, Query, description = "RFC3339 upper bound over started_at. Project-scoped lists default to now; run_id lists are unbounded unless from/to is supplied."),
