...
const endpoint = `${options.baseUrl.replace(/\/$/, "")}/api/imports/mlflow${options.dryRun ? "?dry_run=true" : ""}`;
...
function usage(code, message = "") {
  ...
  console.error("Usage: node tools/import-mlflow-json.mjs <export.json> --project <name> [--base-url http://127.0.0.1:8000] [--dry-run]");
  process.exit(code);
}
