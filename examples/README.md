...
- `object-explorer/`: deterministic rich-object seed data for the `/dashboard/objects` explorer, including text, tables, histograms, and small generated image objects.
