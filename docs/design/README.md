...
- `2026-06-30-aim-gap3-integrations.md`: implemented Aim parity slice for
  broader lazy Python SDK integrations across Optuna, tree-boosting libraries,
  RL callbacks, and dataset metadata helpers.
