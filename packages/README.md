...
- `python-sdk/`: Python SDK for logging runs, auto-step metrics, rich objects, local files/artifacts, optional system metrics, optional console capture, checkpoints, videos, tables, imports, and lazy framework/data integrations.
...
- Optional media/framework/data dependencies are pinned in `packages/python-sdk/requirements-optional.txt` and must remain lazy imports.
